...
<div class="row ceo_dva">
    <div class="col-md-12 boxic">
        <form id="forma" action="{{ route('nabavke.izmena.post', $data->id) }}" method="POST" data-parsley-validate>
            {{ csrf_field() }}
            <div class="row">
                <div class="col-md-4">
                ...
                <div class="col-md-4">
                    <div class="form-group{{ $errors->has('garancija') ? ' has-error' : '' }}">
                        ...
                        <input type="number" id="garancija" name="garancija"
                               class="form-control"
                               value="{{ old('garancija', $data->garancija) }}"

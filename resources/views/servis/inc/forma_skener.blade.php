<form action="{{ route('nabavke.stavke.skeneri.dodavanje') }}" method="POST" data-parsley-validate>
    {{ csrf_field() }}
    ...
    <div class="col-md-12">
        <div class="form-group{{ $errors->has('skener_model_id') ? ' has-error' : '' }}">
            ...
            <select name="skener_model_id" id="skener_model_id" class="chosen-select form-control"
                    data-placeholder="Model skenera ..." required>
                <option value=""></option>

...
@section('naziv', 'Servis | Brisanje opsega statičkih adresa')
...
<div class="row">
    <div class="col-md-8">
        <h1>
            <img class="slicica_animirana" alt="Brisanje opsega statičkih adresa"
                src="{{url('/images/ip.png')}}" style="height:128px;">
            &emsp;Brisanje opsega statičkih adresa
        </h1>
    </div>
</div>
<hr>
<div class="row" style="margin-bottom: 16px;">
    <div class="col-md-12">
        ...
        <form action="{{ route('opseg.obrisi.post') }}" method="POST" data-parsley-validate>
        {{ csrf_field() }}
        ...
        <hr style="border-top: 1px solid #18BC9C">
           ...
           <div class="row dugmici">
            ...
            <div class="col-md-6 snimi">
                <button type="submit" class="btn btn-danger btn-block ono"><i class="fa fa-recycle"></i>&emsp;&emsp;Ukloni</button>
            </div>
            <div class="col-md-6">
                <a class="btn btn-primary btn-block ono" href="{{route('staticke.slobodne')}}"><i class="fa fa-ban"></i>&emsp;&emsp;Otkaži</a>
            </div>
            </div>
            </div>
            </div>

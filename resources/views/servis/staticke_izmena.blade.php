...
@section('naziv', 'Servis | Izmena podataka uređaja vezanog za datu IP adresu')
...
<div class="row">
    <div class="col-md-12">
        <h1>
            ...
            &emsp;zmena podataka uređaja vezanog za IP adresu - {{ $ip->ip_adresa }}
        </h1>
    </div>
</div>
<hr>
    ...
    <div class="col-md-12">
        <div class="btn-group">
            ...
            <a class="btn btn-primary" href="{{ route('staticke.zauzete') }}"
               title="Povratak na listu statičkih IP adresa">
...
<div class="row ceo_dva">
    <div class="col-md-12 boxic">
        <form id="forma" action="{{ route('staticke.izmena.post', $ip->id) }}" method="POST" data-parsley-validate>
            {{ csrf_field() }}
            <div class="row">
                <div class="col-md-3">
                    <div class="form-group{{ $errors->has('kancelarija_id') ? ' has-error' : '' }}">
                        ...
                        <select name="kancelarija_id" id="kancelarija_id" class="chosen-select form-control" data-placeholder="kancelarija ...">
                            ...
                            <option value="{{ $kancelarija->id }}" {{ old( 'kancelarija_id')==$kancelarija->id ? ' selected' : '' }} {{ $ip->kancelarija_id == $kancelarija->id ? ' selected' : ''
                ...
                <div class="col-md-2">
                    <div class="form-group{{ $errors->has('uticnica') ? ' has-error' : '' }}">
                        ...
                        <input type="text" id="uticnica" name="uticnica"
                               class="form-control"
                               value="{{ old('uticnica', $ip->uticnica) }}"
                               maxlength="50">
                ...
                <div class="col-md-4">
                    <div class="form-group{{ $errors->has('prvi_nod') ? ' has-error' : '' }}">
                        ...
                        <input type="text" id="prvi_nod" name="prvi_nod"
                               class="form-control"
                               value="{{ old('prvi_nod', $ip->prvi_nod) }}"
                               maxlength="50">
                ...
                <div class="col-md-4">
                    <div class="form-group{{ $errors->has('opis') ? ' has-error' : '' }}">
                        ...
                        <textarea id="opis" name="opis"
                                  class="form-control">{{ old('opis', $ip->opis) }}</textarea>
                        @if ($errors->has('opis'))
                        <span class="help-block">
                ...
                <div class="col-md-4">
                    <div class="form-group{{ $errors->has('napomena') ? ' has-error' : '' }}">
                        ...
                        <textarea id="napomena" name="napomena"
                                  class="form-control">{{ old('napomena', $ip->napomena) }}</textarea>
            ...
            <div class="row dugmici">
                <div class="col-md-6 col-md-offset-6">
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <a class="btn btn-danger btn-block ono" href="{{route('staticke.zauzete')}}">

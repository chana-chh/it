...
@section('naziv', 'Sifarnici | Otpremnica dodavanje')
...
<div class="row ceo_dva">
    <div class="col-md-12 boxic">
        <form id="forma" action="{{ route('otpremnice.dodavanje.post') }}" method="POST" data-parsley-validate>
            {{ csrf_field() }}
            <div class="row">
                <div class="col-md-4">
                    ...
                    <div class="form-group{{ $errors->has('racun_id') ? ' has-error' : '' }}">
                        ...
                        <select id="racun_id" name="racun_id"
                            ...
                            <option value="{{ $racun->id }}"
                                    {{ old('racun_id', $id_racuna) == $racun->id ? ' selected' : '' }}>
                                    {{ $racun->broj }}</option>
                            @endforeach
                        </select>

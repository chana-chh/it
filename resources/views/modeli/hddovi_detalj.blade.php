...
<div class="row dugmici">
        <div class="col-md-12" style="margin-top: 20px">
            ...
            <div class="col-md-4 text-left">
                <a class="btn btn-info" href="{{route('hddovi.modeli')}}" title="Povratak na listu modela čvrstih diskova"><i class="fa fa-list" style="color:#2C3E50"></i></a>
            </div>

            <div class="col-md-4 text-center">
                <a class="btn btn-info" href="{{route('hddovi.modeli.izmena.get', $hdd->id) }}" title="Izmena osnovnih podataka o modelu čvrstog diska"><i class="fa fa-pencil" style="color:#2C3E50"></i></a>
            </div>
...
<div class="row">
    <div class="col-md-12">
<h3>Broj čvrstih diskova ovog modela: <a href="{{route('hddovi.modeli.uredjaji', $hdd->id) }}" title="Pregled svih uređaja ovog modela čvrstog diska"> {{$hdd->hddovi->count()}} </a></h3>

<h3>Broj računara sa ovim modelom čvrstog diska: <a href="{{route('hddovi.modeli.racunari', $hdd->id) }}" title="Pregled svih računara sa ovim modelom čvrstog diska"> {{$racunari}} </a></h3>
</div>
</div>

<div class="row" style="margin-top: 50px">
<div class="col-md-12 text-center">
    <a href="{{$hdd->link}}" target="_blank"><img alt="link" src="{{url('/images/link.png')}}" style="height:32px;"></a>
</div>
</div>

...
<div class="row">
    <div class="col-md-10">
        <h1>
            <span>
                <img class="slicica_animirana" alt="Modeli čvrstih diskova" src="{{url('/images/hdd.png')}}" style="height:64px;">
            </span>&emsp;Modeli čvrstih diskova</h1>
    </div>

    <div class="col-md-2 text-right" style="padding-top: 50px;">
        <a class="btn btn-primary ono" href="{{route('hddovi.modeli.dodavanje.get')}}">
            <i class="fa fa-plus-circle fa-fw"></i> Dodaj model čvrstog diska</a>
    </div>
</div>
<hr>
<div class="row">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td style="text-align:right; vertical-align: middle; line-height: normal;">
                        <a class="btn btn-success btn-sm" id="dugmeDetalj" href="{{route('hddovi.modeli.detalj', $m->id)}}">
                            <i class="fa fa-eye"></i>
                        </a>
                        <a class="btn btn-info btn-sm" id="dugmeIzmena" href="{{route('hddovi.modeli.izmena.get', $m->id)}}">

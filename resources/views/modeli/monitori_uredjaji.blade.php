...
@section('naslov')
    <div class="row">
        <div class="col-md-10">
            <h1><span><img class="slicica_animirana" alt="Monitori ..." src="{{url('/images/monitorS.png')}}" style="height:64px;"></span>&emsp;Monitori čiji je naziv modela <span style="color: #18bc9c">{{$model->proizvodjac->naziv}} {{$model->naziv}}, {{$model->dijagonala->naziv}} "</span>  </h1>
        </div>

         <div class="col-md-2 text-right" style="padding-top: 50px;">
            <a class="btn btn-primary ono" href=""><i class="fa fa-plus-circle fa-fw"></i> Dodaj monitor</a>
        </div>
        </div>
        <hr>
<div class="row">
...
<div class="row dugmici">
        <div class="col-md-12" style="margin-top: 20px">
            ...
            <div class="col-md-6 text-left">
                <a class="btn btn-info" href="{{route('monitori.modeli.detalj', $model->id)}}" title="Povratak na detaljni pregled modela procesora {{$model->proizvodjac->naziv}} {{$model->naziv}}, {{$model->dijagonala->naziv}} "><i class="fa fa-arrow-left" style="color:#2C3E50"></i></a>
            </div>

...
<div class="row">
    <div class="col-md-10">
        <h1>
            <span>
                <img class="slicica_animirana" alt="Modeli štampača" src="{{url('/images/stampac.png')}}" style="height:64px;">
            </span>&emsp;Modeli štampača</h1>
    </div>

    <div class="col-md-2 text-right" style="padding-top: 50px;">
        <a class="btn btn-primary ono" href="{{route('stampaci.modeli.dodavanje.get')}}">
            <i class="fa fa-plus-circle fa-fw"></i> Dodaj model štampača</a>
    </div>
</div>
        <hr>
<div class="row">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td style="text-align:right; vertical-align: middle; line-height: normal;">
                ...
                <a class="btn btn-info btn-sm" id="dugmeIzmena" href="{{route('stampaci.modeli.izmena.get', $m->id)}}">

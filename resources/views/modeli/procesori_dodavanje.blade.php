...
<div class="row">
    <div class="col-md-8">
        <h1>
            <img class="slicica_animirana" alt="Procesori"
                 src="{{url('/images/cpu_add.png')}}" style="height:64px;">
            &emsp;Dodavanje modela procesora
        </h1>
    </div>
</div>
<hr>
<div class="row" style="margin-bottom: 16px;">
    <div class="col-md-12">
        ...
        <div class="row">
            ...
            <input  type="number" name="godiste" id="godiste" class="form-control" value="{{ old('godiste') }}"
                    min="2000"  step="1">

...
@section('naziv', 'Modeli | Izmena modela napajanja')
...
@section('naslov')
        ...
        <h1 class="page-header"><span><img class="slicica_animirana" alt="Izmena modela napajanja" src="{{url('/images/napajanje.png')}}" style="height:64px;"></span>&emsp;Izmena modela napajanja</h1>

        <form action="{{ route('napajanja.modeli.izmena.post', $model->id) }}" method="POST" data-parsley-validate>
        {{ csrf_field() }}
        ...
        <div class="row">
            <div class="col-md-4">
                    ...
                    <input type="text" name="snaga" id="snaga" class="form-control" value="{{ old('snaga', $model->snaga) }}" maxlength="50">
                    @if ($errors->has('snaga'))
                        <span class="help-block">
    ...
    <div class="row dugmici">
        <div class="col-md-10 col-md-offset-1" style="margin-top: 20px">
            ...
            <div class="col-md-6 text-left">
                <a class="btn btn-info" href="{{route('napajanja.modeli')}}" title="Povratak na listu modela napajanja"><i class="fa fa-list" style="color:#2C3E50"></i></a>
            </div>

...
@section('naziv', 'Modeli | Dodavanje modela štampaca')
...
@section('naslov')
        ...
        <h1 class="page-header"><span><img class="slicica_animirana" alt="Dodavanje modela štampaca" src="{{url('/images/stampac.png')}}" style="height:64px;"></span>&emsp;Dodavanje modela štampaca</h1>

        <form action="{{ route('stampaci.modeli.dodavanje.post') }}" method="POST" data-parsley-validate>
        {{ csrf_field() }}
                ...
                <div class="col-md-4">
                   <div class="form-group{{ $errors->has('tip_stampaca_id') ? ' has-error' : '' }}">
                    ...
                    <select name="tip_stampaca_id" id="tip_stampaca_id" class="chosen-select form-control" data-placeholder="tipovi ..." required>
                        ...
                        <option value="{{ $tip->id }}"{{ old('tip_stampaca_id') == $tip->id ? ' selected' : '' }}>
                            {{ $tip->naziv }}
                        </option>
                        @endforeach
                    </select>
    ...
    <div class="row dugmici">
        <div class="col-md-10 col-md-offset-1" style="margin-top: 20px">
            ...
            <div class="col-md-6 text-left">
                <a class="btn btn-info" href="{{route('stampaci.modeli')}}" title="Povratak na listu modela procesora"><i class="fa fa-list" style="color:#2C3E50"></i></a>
            </div>

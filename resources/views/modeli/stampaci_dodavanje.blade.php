...
@section('naziv', 'Modeli | Dodavanje modela štampača')
...
<div class="row">
    <div class="col-md-8">
        <h1>
            <img class="slicica_animirana" alt="Dodavanje modela štampača"
                 src="{{url('/images/stampac.png')}}" style="height:64px;">
            &emsp;Dodavanje modela štampača
        </h1>
    </div>
</div>
<hr>
<div class="row" style="margin-bottom: 16px;">
    <div class="col-md-12">
        ...
        <div class="row">
            ...
            <label for="link">Link modela štampača: </label>

...
<div class="row">
    <div class="col-md-12">
        <h1>
            <img class="slicica_animirana" alt="Računari ..." src="{{url('/images/mbd.png')}}" style="height:64px;">
            &emsp;Računari u kojima je osnovna ploča model
    ...
    <div class="col-md-12">
        <div class="btn-group">
            <a class="btn btn-primary" href="{{route('osnovne_ploce.modeli.detalj', $model->id)}}"
               title="Povratak na detaljni pregled modela osnovne ploče {{$model->proizvodjac->naziv}} {{$model->naziv}}, {{$model->soket->naziv}}">

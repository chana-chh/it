...
@section('naziv', 'Modeli | Izmena modela memorije')
...
@section('naslov')
        ...
        <h1 class="page-header"><span><img class="slicica_animirana" alt="Modeli memorije - izmena" src="{{url('/images/memorija_edit.png')}}" style="height:64px;"></span>&emsp;Izmena modela memorije</h1>

        <form action="{{ route('memorije.modeli.izmena.post', $memorija->id) }}" method="POST" data-parsley-validate>
        {{ csrf_field() }}
        ...
        <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <select name="proizvodjac_id" id="proizvodjac_id" class="chosen-select form-control" data-placeholder="proizvođač ..." required>
                        ...
                        <option value="{{ $proizvodjac->id }}"
                            ...
                            {{ $memorija->proizvodjac_id == $proizvodjac->id ? ' selected' : '' }}>
                            {{ $proizvodjac->naziv }}
                        </option>
                        @endforeach
                    </select>
                ...
                <div class="col-md-3">
                    ...
                    <select name="tip_memorije_id" id="tip_memorije_id" class="chosen-select form-control" data-placeholder="tipovi ..." required>
                        ...
                        <option value="{{ $t->id }}"
                            ...
                            {{ $memorija->tip_memorije_id == $t->id ? ' selected' : '' }}>
                            {{ $t->naziv }}
                        </option>
                        @endforeach
                    </select>
            ...
            <input  type="number" name="brzina" id="brzina" class="form-control" value="{{ old('brzina', $memorija->brzina) }}"
                    min="256" required>
        ...
        <div class="row">
            ...
            <input  type="number" name="kapacitet" id="kapacitet" class="form-control" value="{{ old('kapacitet', $memorija->kapacitet) }}"
            ...
            <div class="col-md-8">
                <div class="form-group{{ $errors->has('napomena') ? ' has-error' : '' }}">
                    ...
                    <textarea name="napomena" id="napomena" class="form-control">{{ old('napomena', $memorija->napomena) }}</textarea>
        ...
        <div class="row">
            ...
            <input type="url" name="link" id="link" class="form-control" value="{{ old('link', $memorija->link) }}" maxlenght="255">
            @if ($errors->has('link'))
                <span class="help-block">
            ...
            <input  type="number" name="ocena" id="ocena" class="form-control" value="{{ old('ocena', $memorija->ocena) }}"

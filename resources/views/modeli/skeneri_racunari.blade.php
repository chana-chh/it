...
@section('naziv', 'Modeli | Računari - model skenera')
...
@section('naslov')
    <div class="row">
        <div class="col-md-12">
            <h1><span><img class="slicica_animirana" alt="Računari ..." src="{{url('/images/scanner.png')}}" style="height:64px;"></span>&emsp;Računari u kojima je napajanje model <span style="color: #18bc9c">{{$model->proizvodjac->naziv}} {{$model->naziv}}</span>  </h1>
        </div>
        </div>
        <hr>
<div class="row">
    <div class="col-md-12">
@if($racunari->isEmpty())
            <h3 class="text-danger">Trenutno nema računara sa ovim modelom skenera</h3>
        @else
...
<div class="row dugmici">
        <div class="col-md-12" style="margin-top: 20px">
            ...
            <div class="col-md-6 text-left">
                <a class="btn btn-info" href="{{route('skeneri.modeli.detalj', $model->id)}}" title="Povratak na detaljni pregled modela napajanja {{$model->proizvodjac->naziv}} {{$model->naziv}}"><i class="fa fa-arrow-left" style="color:#2C3E50"></i></a>
            </div>

...
<div class="row">
    <div class="col-md-12">
        <h1>
            <img class="slicica_animirana" alt="Računari ..." src="{{url('/images/scanner.png')}}" style="height:64px;">
            &emsp;Računari za koje je vezan skener
...
<div class="row">
    <div class="col-md-12">
        <div class="btn-group">
            <a class="btn btn-primary" href="{{route('skeneri.modeli.detalj', $model->id)}}"
               title="Povratak na detaljni pregled modela skenera {{$model->proizvodjac->naziv}} {{$model->naziv}}">

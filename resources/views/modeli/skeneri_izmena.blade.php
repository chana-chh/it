...
@section('naziv', 'Modeli | Izmena modela skenera')
...
@section('naslov')
        ...
        <h1 class="page-header"><span><img class="slicica_animirana" alt="Izmena modela skenera" src="{{url('/images/scanner.png')}}" style="height:64px;"></span>&emsp;Izmena modela skenera</h1>

        <form action="{{ route('skeneri.modeli.izmena.post', $model->id) }}" method="POST" data-parsley-validate>
        {{ csrf_field() }}
        ...
        <div class="row">
            <div class="col-md-6">
                    ...
                    <input type="text" name="format" id="format" class="form-control" value="{{ old('format', $model->format) }}" maxlength="20">
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" name="rezolucija" id="rezolucija" class="form-control" value="{{ old('rezolucija', $model->rezolucija) }}" maxlength="20">
    ...
    <div class="row dugmici">
        <div class="col-md-10 col-md-offset-1" style="margin-top: 20px">
            ...
            <div class="col-md-6 text-left">
                <a class="btn btn-info" href="{{route('skeneri.modeli')}}" title="Povratak na listu modela skenera"><i class="fa fa-list" style="color:#2C3E50"></i></a>
            </div>

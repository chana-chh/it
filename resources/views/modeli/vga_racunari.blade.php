...
<div class="row">
    <div class="col-md-12">
        <h1>
            <img class="slicica_animirana" alt="Računari ..." src="{{url('/images/vga.png')}}" style="height:64px;">
            &emsp;Računari u kojima je grafički adapter model
    ...
    <div class="col-md-12">
        <div class="btn-group">
            <a class="btn btn-primary" href="{{route('vga.modeli.detalj', $model->id)}}"
               title="Povratak na detaljni pregled modela grafičkog adaptera {{$model->proizvodjac->naziv}}, {{$model->naziv}}">

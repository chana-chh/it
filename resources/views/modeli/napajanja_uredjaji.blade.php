...
<div class="row dugmici">
        <div class="col-md-12" style="margin-top: 20px">
            ...
            <div class="col-md-6 text-left">
                <a class="btn btn-info" href="{{route('napajanja.modeli.detalj', $model->id)}}" title="Povratak na detaljni pregled modela procesora {{$model->proizvodjac->naziv}} {{$model->naziv}}, {{$model->snaga}} W"><i class="fa fa-arrow-left" style="color:#2C3E50"></i></a>
            </div>

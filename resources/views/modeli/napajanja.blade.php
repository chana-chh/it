...
<div class="row">
    <div class="col-md-10">
        <h1>
            <span>
                <img class="slicica_animirana" alt="Modeli napajanja" src="{{url('/images/napajanje.png')}}" style="height:64px;">
            </span>&emsp;Modeli napajanja</h1>
    </div>

    <div class="col-md-2 text-right" style="padding-top: 50px;">
        <a class="btn btn-primary ono" href="{{route('napajanja.modeli.dodavanje.get')}}">
            <i class="fa fa-plus-circle fa-fw"></i> Dodaj model napajanja</a>
    </div>
</div>
        <hr>
<div class="row">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td style="text-align:right; vertical-align: middle; line-height: normal;">
                ...
                <a class="btn btn-info btn-sm" id="dugmeIzmena" href="{{route('napajanja.modeli.izmena.get', $m->id)}}">

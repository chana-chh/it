...
@section('naslov')
        ...
        <h1 class="page-header"><span><img class="slicica_animirana" alt="Modeli osnovnih ploča dodavanje" src="{{url('/images/mbd.png')}}" style="height:64px;"></span>&emsp;Dodavanje modela osnovnih ploča</h1>
    ...
    <div class="row dugmici">
        <div class="col-md-10 col-md-offset-1" style="margin-top: 20px">
            ...
            <div class="col-md-6 text-left">
                <a class="btn btn-info" href="{{route('osnovne_ploce.modeli')}}" title="Povratak na listu modela osnovnih ploča"><i class="fa fa-list" style="color:#2C3E50"></i></a>
            </div>

        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6 no-float" style="background: #2C3E50">
                    <img class="center-block" alt="imenik" src="{{url('/images/imenik.png')}}"
                         style="height: 128px; margin-top: 200px;">
                    <form action="{{ route('pretraga.rezultati') }}" method="POST"
                          class="form-inline text-center" style="margin-top: 150px;">
                        {{ csrf_field() }}
                        <div class="form-group">
                            <label class="sr-only" for="upit">Pretraži</label>
                            <div class="input-group">
                                <div class="input-group-addon"><i class="fa fa-phone" aria-hidden="true"></i></div>
                                <input type="text" name="upit" id="upit" class="form-control" placeholder="Pretraži imenik">
                            </div>
                        </div>

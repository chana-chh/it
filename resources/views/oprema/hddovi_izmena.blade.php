...
@section('naziv', 'Oprema | Izmena čvrstog diska')
...
<div class="row">
    <div class="col-md-8">
        <h1>
            ...
            &emsp;Izmena podataka čvrstog diska
        </h1>
    </div>
</div>
<hr>
...
<div class="row ceo_dva">
    <div class="col-md-12 boxic">
        <form action="{{ route('hddovi.oprema.izmena.post', $uredjaj->id) }}" method="POST" data-parsley-validate>
            {{ csrf_field() }}

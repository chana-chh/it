...
@section('naziv', 'Oprema | Lista mrežnih uređaja za reciklažu')
...
<div class="row obavestenje">
    <div class="col-md-10 col-md-offset-1 text-center" style="font-size: 1rem;;">
        <div class="alert alert-info alert-dismissible ono" role="alert">
            ...
            <strong>Obavštenje: </strong>Čekirajte <input type="checkbox" onclick="return false;"/> uz mrežne uređaje koje želite da reciklirate u navedenoj reciklaži.
        </div>
    </div>
</div>
<div class="row">
    <div class="col-md-10">
        <h2>
            <span>
                <img class="slicica_animirana" alt="Otpisani mrežni uređaji" src="{{url('/images/projektor.png')}}" style="height:64px;">
            </span>&emsp;Lista mrežnih uređaja za reciklažu koja je planirana za <span class="text-success">{{$reciklaza->datum}}</span></h2>
    </div>
    <div class="col-md-2 text-right" style="padding-top: 50px;">
        <form action="{{route('mrezni.oprema.recikliranje', $reciklaza->id)}}" method="POST" id="forma_reciklaza">
            {{ csrf_field() }}
...
<div class="row" style="margin-bottom: 25px; margin-top: 25px">
    <div class="col-md-12">
        <div class="btn-group">
            <a class="btn btn-primary" href="{{route('mrezni.oprema.otpisani')}}"
            ...
            <a class="btn btn-primary" href="{{route('mrezni.oprema')}}"
               title="Povratak na listu mrežnih uređaja">
...
<div class="row">
    <div class="col-md-12">
@if($uredjaj->isEmpty())
            <h3 class="text-danger">Trenutno nema mrežnih uređaja za reciklažu</h3>
        @else
        ...
        <tr>
            ...
            <td>{{$o->proizvodjac->naziv}}, {{$o->naziv}} - {{$o->broj_portova}}&emsp;
                        <span title="U pitanju je upravljiv mrežni uređaj"
                            style="color: #18bc9c;">
                            {!! $o->upravljiv == 1 ? "<i class=\"fa fa-check-square-o\"></i>" : " "!!}
                        </span></td>
            <td> 
                {{$o->deleted_at}}
            </td>

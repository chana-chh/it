...
@section('naziv', 'Oprema | Otpisani čvrsti diskovi')
...
<div class="row">
    <div class="col-md-10">
        <h1>
            <span>
                <img class="slicica_animirana" alt="Otpisani čvrsti diskovi" src="{{url('/images/hdd.png')}}" style="height:64px;">
            </span>&emsp;Otpisani čvrsti diskovi</h1>
    </div>
...
<div class="row well" id="reciklaza_div" style="display: none;">
    ...
    <div class="col-md-6">
        ...
        <form class="form-inline" action="{{route('hddovi.oprema.recikliranje.lista')}}" method="POST" data-parsley-validate style="margin-top: 1.4rem">
            {{ csrf_field() }}
...
$( document ).ready(function() {
        ...
        $(document).on('click', '.vracanje', function () {
            var id = $(this).val();
            $('#idVracanje').val(id);
            var ruta = " {{route('hddovi.oprema.vracanje_otpis') }}";

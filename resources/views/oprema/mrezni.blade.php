...
@section('naziv', 'Oprema | Mrežni uređaji')
...
<div class="row">
    <div class="col-md-10">
        <h1>
            <span>
                <img class="slicica_animirana" alt="Mrežni uređaji" src="{{url('/images/mrezniUredjaji.png')}}" style="height:64px;">
            </span>&emsp;Mrežni uređaji</h1>
    </div>
...
<div class="row well" id="pretraga" style="display: none;">
    <div class="col-md-2">
        <a id="pretragaDugme" href="{{route('mrezni.oprema.otpisani')}}" class="btn btn-success btn-block ono">

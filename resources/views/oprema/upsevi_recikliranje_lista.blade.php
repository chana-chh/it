...
@section('naziv', 'Oprema | Lista Ups uređaja za reciklažu')
...
<div class="row obavestenje">
    <div class="col-md-10 col-md-offset-1 text-center" style="font-size: 1rem;;">
        <div class="alert alert-info alert-dismissible ono" role="alert">
            ...
            <strong>Obavštenje: </strong>Čekirajte <input type="checkbox" onclick="return false;"/> uz Ups uređaje koje želite da reciklirate u navedenoj reciklaži</a>.
        </div>
    </div>
</div>
<div class="row">
    <div class="col-md-10">
        <h2>
            ...
            </span>&emsp;Lista UPS uređaja za reciklažu koja je planirana za <span class="text-success">{{$reciklaza->datum}}</span></h2>
    </div>
    <div class="col-md-2 text-right" style="padding-top: 50px;">
        <form action="{{route('upsevi.oprema.recikliranje', $reciklaza->id)}}" method="POST" id="forma_reciklaza">
            {{ csrf_field() }}
...
<div class="row" style="margin-bottom: 25px; margin-top: 25px">
    <div class="col-md-12">
        <div class="btn-group">
            <a class="btn btn-primary" href="{{route('upsevi.oprema.otpisani')}}"
...
<div class="row">
    <div class="col-md-12">
@if($uredjaj->isEmpty())
            <h3 class="text-danger">Trenutno nema Ups uređaja za reciklažu</h3>
        @else

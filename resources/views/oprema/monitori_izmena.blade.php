...
<div class="row">
    <div class="col-md-8">
        <h1>
            <img class="slicica_animirana" alt="Izmena čvrstog diska" src="{{url('/images/monitorS.png')}}" style="height:64px;"> &emsp;Izmena podataka monitora
        </h1>
    </div>
</div>
<hr>
            ...
            <div class="row dugmici">
                <div class="col-md-6 col-md-offset-6">
                    <div class="form-group text-right">
                        ...
                        <div class="col-md-6">
                            <a class="btn btn-danger btn-block ono" href="{{route('napajanja.oprema')}}">

...
<div class="row obavestenje">
    <div class="col-md-10 col-md-offset-1 text-center" style="font-size: 1rem;;">
        <div class="alert alert-info alert-dismissible ono" role="alert">
            ...
            <strong>Obavštenje: </strong> Dodavanje memorijskih modula se obavlja kroz <a href="{{ route('otpremnice') }}" style="color: #18BC9C"><strong>otpremnicu</strong></a>  ili sa detaljnog pregleda <a href="{{route('racunari.oprema')}}" style="color: #18BC9C"><strong>računara</strong></a>.
        </div>
    </div>
</div>
...
<div class="row well" id="pretraga" style="display: none;">
    <div class="col-md-2">
        <a id="pretragaDugme" href="{{route('memorije.oprema.otpisani')}}" class="btn btn-success btn-block ono">
...
<table id="tabela" class="table table-striped display" cellspacing="0" width="100%">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td><a href="{{route('memorije.modeli.detalj', $o->memorijaModel->id)}}">{{$o->memorijaModel->proizvodjac->naziv}} {{$o->memorijaModel->naziv}}, {{$o->memorijaModel->kapacitet}}</a></td>
            <td> @if($o->racunar)
                {{$o->racunar->ime}}
                @endif
            ...
            <td style="text-align:right; vertical-align: middle; line-height: normal;">
                <a class="btn btn-success btn-sm" id="dugmeDetalj" href="{{route('memorije.oprema.detalj', $o->id)}}">
                    <i class="fa fa-eye"></i>
                </a>
                <a class="btn btn-info btn-sm" id="dugmeIzmena" href="{{route('memorije.oprema.izmena.get', $o->id)}}">

...
@section('naziv', 'Oprema | Izmena podataka servera')
...
<div class="row">
    <div class="col-md-8">
        <h1>
            <img class="slicica_animirana" alt="Server"
                 src="{{url('/images/server.png')}}" style="height:64px;">
            &emsp;Izmena podataka servera <strong class="text-success">{{$server->ime}}</strong>
        </h1>
    </div>
</div>
<hr>
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="form-group checkboxoviforme">
                        <label>
                            <input type="checkbox" name="firewall" id="firewall" {!!$server->firewall == 0 ? "" :'checked="checked"'!!}> &emsp;Da li je firewall aktivan na serveru?
                        </label>
                    </div>
                </div>
                ...
                <div class="col-md-4">
                    <div class="form-group checkboxoviforme">
                        <label>
                            <input type="checkbox" name="virtuelni" id="virtuelni" {!!$server->virtuelni == 0 ? "" :'checked="checked"'!!}> &emsp;Da li se radi o virtualnom serveru?
                        </label>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="form-group{{ $errors->has('host') ? ' has-error' : '' }}">
                        ...
                        <input type="text" name="host" id="host" class="form-control" value="{{ old('host', $server->host) }}" maxlength="20"> @if ($errors->has('host'))
        ...
        <div class="row">
            <div class="col-md-4">
                <div class="form-group{{ $errors->has('ime') ? ' has-error' : '' }}">
                    ...
                    <input type="text" name="ime" id="ime" class="form-control" value="{{ old('ime', $server->ime) }}" maxlength="20" required> @if ($errors->has('ime'))
                    <span class="help-block">
            ...
            <div class="col-md-4">
                <div class="form-group{{ $errors->has('domen') ? ' has-error' : '' }}">
                    ...
                    <input type="text" name="domen" id="domen" class="form-control" value="{{ old('domen', $server->domen) }}" maxlength="50"> @if ($errors->has('domen'))
                    <span class="help-block">
            ...
            <div class="col-md-4">
                    <div class="form-group{{ $errors->has('kancelarija_id') ? ' has-error' : '' }}">
                        ...
                        <select name="kancelarija_id" id="kancelarija_id" class="chosen-select form-control" data-placeholder="kancelarija ...">
                            ...
                            <option value="{{ $kancelarija->id }}" {{ old( 'kancelarija_id')==$kancelarija->id ? ' selected' : '' }} {{ $server->kancelarija_id == $kancelarija->id ? ' selected' : '' }}>
        ...
        <div class="row">
            <div class="col-md-4">
                <div class="form-group{{ $errors->has('rack') ? ' has-error' : '' }}">
                    ...
                    <input type="text" name="rack" id="rack" class="form-control" value="{{ old('rack', $server->rack) }}" maxlength="50"> @if ($errors->has('rack'))
                    <span class="help-block">
            ...
            <div class="col-md-4">
                <div class="form-group{{ $errors->has('ups') ? ' has-error' : '' }}">
                    ...
                    <input type="text" name="ups" id="ups" class="form-control" value="{{ old('ups', $server->ups) }}" maxlength="50"> @if ($errors->has('ups'))
                    <span class="help-block">
...
<div class="row">
    ...
    <div class="col-md-4">
        <div class="form-group{{ $errors->has('rola') ? ' has-error' : '' }}">
            ...
            <input type="text" name="rola" id="rola" class="form-control" value="{{ old('rola', $server->rola) }}" maxlength="255" required> @if ($errors->has('rola'))
            <span class="help-block">
    ...
    <div class="col-md-8">
        <div class="form-group{{ $errors->has('rola_opis') ? ' has-error' : '' }}">
            ...
            <textarea name="rola_opis" id="rola_opis" class="form-control">{{ old('rola_opis', $server->rola_opis) }}</textarea>
...
<div class="row">
    <div class="col-md-4">
        <div class="form-group{{ $errors->has('os_id') ? ' has-error' : '' }}">
            ...
            <select name="os_id" id="os_id" class="chosen-select form-control" data-placeholder="os ...">
                ...
                @foreach($os as $si)
                <option value="{{ $si->id }}" 
                    {{ old( 'os_id') == $si->id ? ' selected' : '' }}
                    {{ $server->os_id == $si->id ? ' selected' : '' }}>
                    {{$si->naziv}}
            </option>
    ...
    <div class="col-md-4">
        <div class="form-group{{ $errors->has('model') ? ' has-error' : '' }}">
            ...
            <input type="text" name="model" id="model" class="form-control" value="{{ old('model', $server->model) }}" maxlength="50"> @if ($errors->has('model'))
            <span class="help-block">
...
<div class="row">
    <div class="col-md-3">
        <div class="form-group{{ $errors->has('ip_adresa') ? ' has-error' : '' }}">
            ...
            <input type="text" name="ip_adresa" id="ip_adresa" class="form-control" value="{{ old('ip_adresa', $server->ip_adresa) }}"
    ...
    <div class="col-md-3">
        <div class="form-group{{ $errors->has('default_gw') ? ' has-error' : '' }}">
            ...
            <input type="text" name="default_gw" id="default_gw" class="form-control" value="{{ old('default_gw', $server->default_gw) }}"
    ...
    <div class="col-md-3">
        <div class="form-group{{ $errors->has('cpu') ? ' has-error' : '' }}">
            ...
            <input type="text" name="cpu" id="cpu" class="form-control" value="{{ old('cpu', $server->cpu) }}" maxlength="50"> @if ($errors->has('cpu'))
            <span class="help-block">
    ...
    <div class="col-md-3">
        <div class="form-group{{ $errors->has('ram') ? ' has-error' : '' }}">
            ...
            <input type="text" name="ram" id="ram" class="form-control" value="{{ old('ram', $server->ram) }}" maxlength="50"> @if ($errors->has('ram'))
            <span class="help-block">
...
<div class="row">
    <div class="col-md-4">
        <div class="form-group{{ $errors->has('napomena') ? ' has-error' : '' }}">
            ...
            <textarea name="napomena" id="napomena" class="form-control">{{ old('napomena', $server->napomena) }}</textarea>

...
@section('naziv', 'Oprema | UPS uređaji')
...
<div class="row">
    <div class="col-md-10">
        <h1>
            <span>
                <img class="slicica_animirana" alt="UPS uređaji" src="{{url('/images/ups1.jpg')}}" style="height:64px;">
            </span>&emsp;UPS uređaji</h1>
    </div>
...
<div class="row obavestenje">
    <div class="col-md-10 col-md-offset-1 text-center" style="font-size: 1rem;;">
        <div class="alert alert-info alert-dismissible ono" role="alert">
            ...
            <strong>Obavštenje: </strong> Dodavanje novog UPS uređaja se obavlja kroz <a href="{{ route('otpremnice') }}" style="color: #18BC9C"><strong> otpremnicu </strong></a> ili <a href="{{route('nabavke')}}" style="color: #18BC9C"><strong> nabavku </strong></a>.
        </div>
    </div>
</div>
...
<div class="row well" id="pretraga" style="display: none;">
    <div class="col-md-2">
        <a id="pretragaDugme" href="{{route('upsevi.oprema.otpisani')}}" class="btn btn-success btn-block ono">
...
<table id="tabela" class="table table-striped display" cellspacing="0" width="100%" style="table-layout: fixed; font-size: 0.9375em;">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td><a href="{{route('upsevi.modeli.detalj', $o->upsModel->id)}}">{{$o->upsModel->proizvodjac->naziv}}, {{$o->upsModel->kapacitet}} VA {{$o->upsModel->snaga}} W</a></td>
            <td> @if($o->racunar)
                {{$o->racunar->ime}}
                @endif
            ...
            <td style="text-align:right; vertical-align: middle; line-height: normal;">
                <a class="btn btn-success btn-sm" id="dugmeDetalj" href="{{route('upsevi.oprema.detalj', $o->id)}}">
                    <i class="fa fa-eye"></i>
                </a>
                <a class="btn btn-info btn-sm" id="dugmeIzmena" href="{{route('upsevi.oprema.izmena.get', $o->id)}}">

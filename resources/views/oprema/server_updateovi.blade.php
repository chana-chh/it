...
<div class="row">
    <div class="col-md-10">
        <h1>
            <i class="fa fa-bomb fa-fw text-primary"></i>&emsp;Ažuriranja za server <strong class="text-success">{{$server->ime}}</strong></h1>
    </div>
    <div class="col-md-2 text-right" style="padding-top: 50px;">
        <a class="btn btn-primary ono" href="{{route('serveri.dodavanje.up.get', $server->id)}}"><i class="fa fa-plus-circle fa-fw"></i> Dodaj ažuriranje</a>
    </div>
</div>

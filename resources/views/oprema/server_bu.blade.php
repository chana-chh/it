...
<div class="row">
    <div class="col-md-10">
        <h1>
            <i class="fa fa fa-archive fa-fw text-primary"></i>&emsp;Rezervne kopije svih servera</h1>
    </div>
    <div class="col-md-2 text-right" style="padding-top: 50px;">
        <a class="btn btn-primary ono" href="{{route('serveri.dodavanje.bu.get')}}"><i class="fa fa-plus-circle fa-fw"></i> Dodaj rezervnu kopiju</a>
    </div>
</div>

...
@section('naziv', 'Oprema | Projektori')
...
<div class="row">
    <div class="col-md-10">
        <h1>
            <span>
                <img class="slicica_animirana" alt="Projektori" src="{{url('/images/projektor.png')}}" style="height:64px;">
            </span>&emsp;Projektori</h1>
    </div>
...
<div class="row well" id="pretraga" style="display: none;">
    <div class="col-md-2">
        <a id="pretragaDugme" href="{{route('projektori.oprema.otpisani')}}" class="btn btn-success btn-block ono">
...
<table id="tabela" class="table table-striped display" cellspacing="0" width="100%" style="table-layout: fixed; font-size: 0.9375em;">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>{{$o->proizvodjac->naziv}}, {{$o->naziv}} - {{$o->rezolucija}}</td>
            <td> @if($o->kancelarija)
            ...
            <td style="text-align:right; vertical-align: middle; line-height: normal;">
                <a class="btn btn-success btn-sm" id="dugmeDetalj" href="{{route('projektori.oprema.detalj', $o->id)}}">
                    <i class="fa fa-eye"></i>
                </a>
                <a class="btn btn-info btn-sm" id="dugmeIzmena" href="{{route('projektori.oprema.izmena.get', $o->id)}}">

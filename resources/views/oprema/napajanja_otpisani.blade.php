...
@section('naziv', 'Oprema | Otpisana napajanja')
...
<div class="row">
    <div class="col-md-10">
        <h1>
            <span>
                <img class="slicica_animirana" alt="Otpisana napajanja" src="{{url('/images/napajanje.png')}}" style="height:64px;">
            </span>&emsp;Otpisana napajanja</h1>
    </div>
    ...
    <div class="col-md-12">
        <div class="btn-group">
            ...
            <a class="btn btn-primary" href="{{ route('napajanja.oprema') }}"
               title="Povratak na listu aktivnih napajanja">
...
<div class="row well" id="reciklaza_div" style="display: none;">
    ...
    <div class="col-md-6">
        ...
        <form class="form-inline" action="{{route('napajanja.oprema.recikliranje.lista')}}" method="POST" data-parsley-validate style="margin-top: 1.4rem">
            {{ csrf_field() }}
...
$( document ).ready(function() {
        ...
        $(document).on('click', '.vracanje', function () {
            var id = $(this).val();
            $('#idVracanje').val(id);
            var ruta = " {{route('napajanja.oprema.vracanje_otpis') }}";

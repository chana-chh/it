...
@section('naziv', 'Šifarnici | Dodavanje licenci')
...
<div class="row">
    <div class="col-md-8">
        <h1>
            <img class="slicica_animirana" alt="Dodavanje licenci"
                 src="{{url('/images/licence.png')}}" style="height:64px;">
            &emsp;Dodavanje licenci
        </h1>
    </div>
</div>
<hr>
...
<div class="row ceo_dva">
    <div class="col-md-12 boxic">
        <form action="{{ route('licence.dodavanje.post') }}" method="POST" data-parsley-validate>
            {{ csrf_field() }}
                ...
                <div class="col-md-6">
                    <div class="form-group{{ $errors->has('tip_licence') ? ' has-error' : '' }}">
                        ...
                        <input type="text" name="tip_licence" id="tip_licence" class="form-control"
                               value="{{ old('tip_licence') }}" maxlength="50" required>

...
@section('naziv', 'Šifarnici | Dodavanje dobavljača')
...
<div class="row">
    <div class="col-md-8">
        <h1>
            <img class="slicica_animirana" alt="Dodavanje dobavljača"
                src="{{url('/images/kamion.png')}}" style="height:64px;">
            &emsp;Dodavanje dobavljača
        </h1>
    </div>
</div>
<hr>
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="form-group{{ $errors->has('naziv') ? ' has-error' : '' }}">
                        ...
                        <input type="text" name="naziv" id="naziv" class="form-control" value="{{ old('naziv') }}" maxlength="190" required> @if ($errors->has('naziv'))
                ...
                <div class="col-md-6">
                    <div class="form-group{{ $errors->has('adresa_mesto') ? ' has-error' : '' }}">
                        ...
                        <input type="text" name="adresa_mesto" id="adresa_mesto" class="form-control" value="{{ old('adresa_mesto') }}" maxlength="50"> @if ($errors->has('adresa_mesto'))
                        <span class="help-block">
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="form-group{{ $errors->has('adresa_ulica') ? ' has-error' : '' }}">
                        ...
                        <input type="text" name="adresa_ulica" id="adresa_ulica" class="form-control" value="{{ old('adresa_ulica') }}" maxlength="100"> @if ($errors->has('adresa_ulica'))
                        <span class="help-block">
                ...
                <div class="col-md-4">
                    <div class="form-group{{ $errors->has('adresa_broj') ? ' has-error' : '' }}">
                        ...
                        <input type="text" name="adresa_broj" id="adresa_broj" class="form-control" value="{{ old('adresa_broj') }}" maxlength="50"> @if ($errors->has('adresa_broj'))
                        <span class="help-block">
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="form-group{{ $errors->has('telefon') ? ' has-error' : '' }}">
                        ...
                        <input type="text" name="telefon" id="telefon" class="form-control" value="{{ old('telefon') }}" required> @if ($errors->has('telefon'))
                        <span class="help-block">

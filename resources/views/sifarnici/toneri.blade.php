...
@section('naziv', 'Šifarnici | Toneri')
...
<h1 class="page-header">
    <img class="slicica_animirana" alt="Toneri"
         src="{{ url('/images/toneri.jpg') }}" style="height:64px;">
    &emsp;Toneri
</h1>
@endsection
        ...
        <div class="row dugmici">
            <div class="col-md-12" style="margin-top: 20px;">
                <div class="form-group">
                    ...
                    <div class="col-md-6">
                        <a class="btn btn-danger btn-block ono" href="{{route('toneri')}}">
...
<script>
    $(document).ready(function () {
        ...
        $(document).on('click', '.otvori-brisanje', function () {
            var id = $(this).val();
            $('#idBrisanje').val(id);
            var ruta = "{{ route('toneri.brisanje') }}";
            $('#brisanje-forma').attr('action', ruta);
        });

        $(document).on('click', '.otvori-izmenu', function () {
            var id = $(this).val(                            );
            var ruta = "{{ route('toneri.detalj') }}";
            $.ajax({
                url: ruta,
                type: "POST",
                data: {

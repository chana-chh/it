...
class MonitoriKontroler extends Kontroler
{
    ...
    public function postOtpis(Request $request)
    {
        ...
        if ($odgovor) {
            ...
            Session::flash('greska', 'Došlo je do greške prilikom otpisa monitori. Pokušajte ponovo, kasnije!');
        }
        return redirect()->route('monitori.oprema');
    }
    ...
    public function postOtpisVracanje(Request $request)
    {
        ...
        if ($odgovor) {
            ...
            Session::flash('greska', 'Došlo je do greške prilikom vraćanja monitori iz otpisa. Pokušajte ponovo, kasnije!');
        }
